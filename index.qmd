...
2.  **Ethical Econometrics**: Instructing students in econometrics as an applied statistics discipline, avoiding the statistical cavaliering that a plague in the econometric publication playbook. 
...
I have published thirteen peer reviewed internationally acclaimed academic papers (1 ABS4, 10 ABS3s, and 2 ABS2s), three commission research reports, two statistical software research packages.My research lies at the intersection of finance, economics, and data science, with a focus on developing innovative analytical approaches to address complex issues in financial markets, regulation, and sustainability. My work is characterised by the application of advanced statistical, econometric, and machine learning techniques across a diverse range of financial and economic contexts.

## Selected Publications

- <span style="color: #2E8B57;">Liu, Weilong, Zhang, Yong, Liu, Kailong, Quinn, Barry, Yang, Xingyu, Peng, Qiao (2024). Evolutionary Multi-Objective Optimisation for Large-Scale Portfolio Selection With Both Random and Uncertain Returns. IEEE Transactions on Evolutionary Computation^ABS4^</span>
...
- <span style="color: #0066cc;">Quinn, Barry, Gallagher, Ronan, Kuosmanen, Timo (2023). Lurking in the shadows: The impact of CO2 emissions target setting on carbon pricing in the Kyoto agreement period Energy Economics^ABS3^</span>
...
- <span style="color: #0066cc;">Gallagher, Ronan, Quinn, Barry (2020). Regulatory own goals: The unintended consequences of economic regulation in professional football. European Sport Management Quarterly^ABS3^</span>
...
1.  **Understanding and Enhancing regulatory compliance in the Investment Managent industry using generative AI** (2024-present UKRI funded Feasiblity Study with Funds Axis Ltd)
2.  **Anomaly detection of large heterogeneous trading transaction and commmunication data** (2021-present)
  - Market Microstructure Expert in collaboration with QUB computer science and Citigroup Belfast(directly funded at £500K)
...
4.  Dr. Kevin Johnson (graduated 2019) *A Case Study in Industrial Consolidation: The Irish Credit Union Sector* **(Co Supervised)**
5.  Dr. Qiao (Olivia) Peng (graduated 2021) *US Credit Union Mergers: Causes and Consequences* **(Co Supervised)**
...
read.csv("Grant_income.csv") %>%
  knitr::kable(
    col.names = c("Source", "Role", "Start", "End", "People", "Title", "Amount", "Type"),
    align = c("l", "l", "l", "l", "l", "l", "r", "l"),  # right-align Amount
    format = "pipe",
...
- Quinn, Barry (2022). Time Series Econometrics R Package. . https://github.com/quinfer/tsfe 341 stars on GitHub
- Quinn, Barry (2020). Financial Machine Learning R package. . https://github.com/quinfer/fml 150 Stars on GitHub
