...
As a Professor of Finance and FinTech at Ulster University Business School, I work as an applied econometrician exploring the intersection of finance, technology, and data science. My research applies statistical and machine learning techniques to problems in financial markets, regulation, and cooperative finance, with growing interest in AI applications within financial services.
I am fortunate to collaborate with colleagues across disciplines and to work alongside industry partners on questions ranging from regulatory compliance to systemic risk assessment. Through research projects funded by UKRI, Innovate UK, and other bodies, I have had the opportunity to investigate market behaviour, credit union performance, and regulatory technology applications.

My teaching spans quantitative finance, econometrics, and emerging technologies—areas where I hope to help students develop both technical competence and critical thinking skills. As a Chartered Statistician, I am particularly committed to promoting ethical approaches to data analysis and evidence-based decision-making. Before entering academia, I worked in financial markets as a currency trader and liquidity manager, an experience that continues to inform my perspective on the practical relevance of econometric research.

I remain a student of these rapidly evolving fields, currently pursuing an MSc in Artificial Intelligence to better understand the technologies reshaping finance. My aim is to contribute meaningfully to conversations about how we can harness technological advances whilst maintaining statistical rigour and regulatory prudence in financial services.
...
-   Kearney, Fearghal, Quinn, Barry, Abhishek Pramanick (Under Review at Journal of Business Venturing) *Innovation Signals and Strategic Exits: How Technological Readiness Shapes RegTech Venture Outcomes*
