...
Professor Barry Quinn is Professor of Finance and Financial Technology at Ulster University Business School and Director of the Centre for Finance and Responsible Technology. A Chartered Statistician, he treats econometrics as an applied statistical science: assumptions made explicit, uncertainty taken seriously, and claims kept proportionate to what the evidence will bear.

His research sits at the meeting point of finance, statistical learning, and responsible use of algorithms. The questions are practical: what markets and institutions reveal under stress; how risk should be measured; and what evidence regulation and compliance can stand over when algorithmic systems shape decisions. He works with industry and policy partners, and aims for analysis that is transparent, reproducible, and usable under operational scrutiny.

Before academia he specialised in currency trading and liquidity management. He holds a PhD in Finance and an MSc in Artificial Intelligence from Queen's University Belfast, and teaches quantitative finance, econometrics, and AI in finance with the same emphasis on ethical practice, reproducibility, and critical thinking.
...
3.  **Financial Data Science** (Ulster University): The disciplined study of variation and uncertainty in financial data—covering return predictability, volatility modelling, factor models, and ML for cross-sectional analysis. Emphasises distinguishing signal from noise, proper model validation, and intellectual humility about the limits of prediction in noisy markets. Supported by an open companion textbook, [*Statistical Science for Finance: Rigorous Methods for Technology-Enabled Markets*](https://financialdatascience.co.uk/).
...
{{< include ../sections/_phd_examinations.md >}}
